...
binary_path = '/tmp/challenge_binary_vaddr'
...
# Different address formats to try
addresses_to_try = [
    "103c",           # Simple relative
    "3c",             # Entry relative  
    "40103c",         # With some base
    "401000",         # __bss_start address
    "1000",           # Simple offset
]
...
print(f"Question: {response.decode().strip()}")

# Let's try 40103c (common CTF format)
test_addr = "40103c"
print(f"Trying address: {test_addr}")
